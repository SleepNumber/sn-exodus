...
export class Breakpoint extends Enumify {
  static mb = new Breakpoint({ name: 'mobile', start: 0 });
  static tb = new Breakpoint({ name: 'tablet', start: 768 });
  static dt = new Breakpoint({ name: 'desktop', start: 1025 });
...
export const events = {
  wheel:
    isBrowser && 'onwheel' in document.createElement('div')
      ? 'wheel'
      : 'mousewheel',
