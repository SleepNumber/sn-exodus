...
function buildUrl(endpoint) {
  ...
  const origin = _constants__WEBPACK_IMPORTED_MODULE_0__.win.location.origin;
...
/* harmony import */ var _Cookie__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6531);
/* harmony import */ var _json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5891);
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3820);
...
function client(_ref) {
  ...
  const url = (0,_url__WEBPACK_IMPORTED_MODULE_3__.buildUrl)(endpoint, params, traditional);
  return fetch(url, config).then(async response => {
    const text = await response.text();
    const isJsonResponse = (0,_json__WEBPACK_IMPORTED_MODULE_2__.isJson)(response);
