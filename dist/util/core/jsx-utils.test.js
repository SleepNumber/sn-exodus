...
// UNUSED EXPORTS: Blank, ConditionalWrapper, common_input_props, displayableType, entitiesOf, validators
...
const entitiesOf = type => PT.shape({
...
/* harmony import */ var _jsx_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4367);
...
describe('util/jsx-utils.js#text', () => {
  it('supSpecial works with no special characters', () => {
    const input = 'foo bar';
    const result = _jsx_utils__WEBPACK_IMPORTED_MODULE_0__.text.supSpecial(input);
