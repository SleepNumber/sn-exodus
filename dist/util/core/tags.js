...
/* harmony export */   hasTags: () => (/* binding */ hasTags)
/* harmony export */ });
/* harmony import */ var _set__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1144);
...
function hasTags(taggable, tags) {
  const tgs = (0,_string__WEBPACK_IMPORTED_MODULE_0__.isString)(tags) ? tags.split(',').map(t => t.trim()) : tags;
  return (0,_set__WEBPACK_IMPORTED_MODULE_1__.isSuperset)(taggable?.tags || [], tgs);
}
})();
