...
describe('element.js', () => {
  ...
  test('util/element.addListeners', () => {
    ...
    (0,react_namespaceObject.render)( /*#__PURE__*/external_react_default().createElement(Btn, {
      listeners: {
        click: onclick
      }
    }));
    let btn = react_namespaceObject.screen.getByText(/click me/i);
    react_namespaceObject.fireEvent.click(btn);
    ...
    btn = react_namespaceObject.screen.getByText(/click me/i);
    react_namespaceObject.fireEvent.focus(btn);
    react_namespaceObject.fireEvent.focus(btn);
    react_namespaceObject.fireEvent.focus(btn);
  ...
  test('util/element.removeListeners', () => {
    ...
    const btn = react_namespaceObject.screen.getByText(/click me/i);
    react_namespaceObject.fireEvent.click(btn);
    expect(onclick).toHaveBeenCalledTimes(1);
