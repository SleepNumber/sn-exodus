...
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = ((/* unused pure expression or super */ null && (Deferred)));
...
class ProductAsset {
  ...
  static isAssetLike(o) {
    ...
    return (0,_object__WEBPACK_IMPORTED_MODULE_0__/* .has */ .e$)(o, props);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProductAsset);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VT: () => (/* binding */ includesAny),
/* harmony export */   pi: () => (/* binding */ includesAll)
/* harmony export */ });
...
function includesAll(arrA, arrB) {
  return (0,_set__WEBPACK_IMPORTED_MODULE_2__/* .isSuperset */ .Os)(new Set(arrA), new Set(arrB));
}
...
function includesAny(arrA, arrB) {
  return (0,_set__WEBPACK_IMPORTED_MODULE_2__/* .intersection */ .jV)(new Set(arrA), new Set(arrB)).size > 0;
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EQ: () => (/* binding */ qaUrl),
...
/* harmony export */ });
/* unused harmony exports setProp, values, reverse, shallowEqual, shrink, eq, isPlainObject, extend, type */
/* OBJECT UTILS
   --------------------------------------------------------------- */
...
/* harmony export */ });
/* unused harmony exports Transformers, getCloudinaryTransformData */
/**
...
__webpack_require__.d(__webpack_exports__, {
  AS: () => (/* binding */ asJpg),
  fM: () => (/* binding */ asMp4),
  yb: () => (/* binding */ base64GifToSrc),
  jR: () => (/* binding */ buildSources),
  h3: () => (/* binding */ filterAssetsByTags),
  ke: () => (/* binding */ findAssetByTags),
  Zt: () => (/* binding */ findImageByTags),
  KV: () => (/* binding */ findImagesByTags),
  v2: () => (/* binding */ findVideoByTags),
  kR: () => (/* binding */ findVideosByTags),
  UL: () => (/* binding */ getAssetCoverSize),
  eO: () => (/* binding */ getBgImages),
  BB: () => (/* binding */ getCloudinaryUrl),
  IO: () => (/* binding */ getCloudinaryVersion),
  pz: () => (/* binding */ getImageDimensions),
  xI: () => (/* binding */ getOptimizedVideo),
  GK: () => (/* binding */ getVideoPlaceholder),
  fP: () => (/* binding */ getVideoPoster),
  $x: () => (/* binding */ getVideoThumb),
  oo: () => (/* binding */ hexToRgb),
  s8: () => (/* binding */ importAll),
  rm: () => (/* binding */ isFullscreen),
  Ns: () => (/* binding */ isJpg),
  MW: () => (/* binding */ isMp4),
  Bw: () => (/* binding */ isSecure),
  IZ: () => (/* binding */ isVideoFullscreen),
  CU: () => (/* binding */ placehold),
  jW: () => (/* binding */ retainFormat),
  vq: () => (/* binding */ rgbToHex),
  bE: () => (/* binding */ safePause),
  FA: () => (/* binding */ safePlay),
  dP: () => (/* binding */ sslUrl),
  GL: () => (/* binding */ stripCloudinaryUrl),
  V9: () => (/* binding */ toggleFullscreen),
  lW: () => (/* binding */ withSpecialtyTag),
  VQ: () => (/* binding */ withoutSpecialtyTag)
});
...
function withSpecialtyTag(_ref) {
  ...
  return tags.includes(core_tags/* Tag */.V.flextop) || tags.includes(core_tags/* Tag */.V.split);
}
...
function getCloudinaryUrl(url) {
  ...
  const origin = (constants/* win */.p_ || window).location.origin;
  ...
  if (origin === constants/* qaUrl */.EQ) cloudName = 'snbr-qa';
  if (origin === constants/* stageUrl */.dT) cloudName = 'snbr-stg';
  if (origin === constants/* localUrl */.hG) cloudName = 'snbr-local';
...
function getVideoPlaceholder(asset) {
  ...
  if (asset instanceof ProductAsset/* default */.Z || ProductAsset/* default */.Z.isAssetLike(asset)) {
    url = asset.url;
  ...
  if (asset instanceof MediaSource/* default */.Z) url = asset.src;
  if (!url.includes('cloudinary.com') && !url.includes('cdn.sleepnumber.com')) {
    // not a cloudinary url
    return result;
  }
  result = (0,cloudinary/* updateCloudinaryTransforms */.VN)(url, [`so_${time}`]);
...
function getVideoPoster(asset) {
  ...
  result = (0,cloudinary/* updateCloudinaryTransforms */.VN)(result, ['co_black', 'e_colorize:20']);
  return result;
}
...
function getVideoThumb(video) {
  ...
  const thumb = (0,cloudinary/* setCloudinaryTransforms */.ih)(url, transforms);
...
function getOptimizedVideo(videoUrl, width, keepOriginalWidth) {
  ...
  const sources = formats.map(_ref3 => {
    ...
    return MediaSource/* default */.Z.of(src, type);
  });
  return sources;
}
...
function filterAssetsByTags(collection, tags, exclude) {
  ...
  const assets = collection.filter(asset => {
    const includes = (0,array/* includesAll */.pi)(asset.tags || [], include);
    let hasExcluded = false;
    if (exclude) {
      let exclude_these = exclude;
      if (typeof exclude === 'string') exclude_these = [exclude];
      hasExcluded = (0,array/* includesAny */.VT)(asset.tags, exclude_these);
    }
...
function findAssetByTags(collection, tags, exclude) {
  ...
  const asset = collection.find(asset => {
    ...
    if (exclude) {
      let exclude_these = exclude;
      if ((0,string/* isString */.HD)(exclude)) exclude_these = [exclude];
      hasExcluded = (0,array/* includesAny */.VT)(asset.tags, exclude_these);
    }
    return includes && !hasExcluded;
  });
...
function safePlay(media) {
  let onFailure = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : core_function/* noop */.ZT;
  const asset = media?.current ? media.current : media;
  if (!asset) return Promise.reject(new Error('No media asset provided'));
  if (!(0,core_function/* isFunc */.Wl)(asset?.play)) return Promise.reject(new Error('Not playable'));
  const promise = asset.play() || Promise.resolve();
  promise.catch(error => {
    // Autoplay was prevented.
    logger/* default */.Z.log('Play was prevented on asset:', asset, 'Error:', error);
    onFailure(error);
  });
  return promise;
}
...
function safePause(media) {
  // Allow React refs
  const asset = media?.current ? media.current : media;
  if ((0,core_function/* isFunc */.Wl)(asset?.pause)) asset.pause();
}
...
function getBgImages(target) {
  const results = [];
  const element = (0,core_element/* getElement */.sb)(target);
...
var __webpack_exports__asJpg = __webpack_exports__.AS;
var __webpack_exports__asMp4 = __webpack_exports__.fM;
var __webpack_exports__base64GifToSrc = __webpack_exports__.yb;
var __webpack_exports__buildSources = __webpack_exports__.jR;
var __webpack_exports__filterAssetsByTags = __webpack_exports__.h3;
var __webpack_exports__findAssetByTags = __webpack_exports__.ke;
var __webpack_exports__findImageByTags = __webpack_exports__.Zt;
var __webpack_exports__findImagesByTags = __webpack_exports__.KV;
var __webpack_exports__findVideoByTags = __webpack_exports__.v2;
var __webpack_exports__findVideosByTags = __webpack_exports__.kR;
var __webpack_exports__getAssetCoverSize = __webpack_exports__.UL;
var __webpack_exports__getBgImages = __webpack_exports__.eO;
var __webpack_exports__getCloudinaryUrl = __webpack_exports__.BB;
var __webpack_exports__getCloudinaryVersion = __webpack_exports__.IO;
var __webpack_exports__getImageDimensions = __webpack_exports__.pz;
var __webpack_exports__getOptimizedVideo = __webpack_exports__.xI;
var __webpack_exports__getVideoPlaceholder = __webpack_exports__.GK;
var __webpack_exports__getVideoPoster = __webpack_exports__.fP;
var __webpack_exports__getVideoThumb = __webpack_exports__.$x;
var __webpack_exports__hexToRgb = __webpack_exports__.oo;
var __webpack_exports__importAll = __webpack_exports__.s8;
var __webpack_exports__isFullscreen = __webpack_exports__.rm;
var __webpack_exports__isJpg = __webpack_exports__.Ns;
var __webpack_exports__isMp4 = __webpack_exports__.MW;
var __webpack_exports__isSecure = __webpack_exports__.Bw;
var __webpack_exports__isVideoFullscreen = __webpack_exports__.IZ;
var __webpack_exports__placehold = __webpack_exports__.CU;
var __webpack_exports__retainFormat = __webpack_exports__.jW;
var __webpack_exports__rgbToHex = __webpack_exports__.vq;
var __webpack_exports__safePause = __webpack_exports__.bE;
var __webpack_exports__safePlay = __webpack_exports__.FA;
var __webpack_exports__sslUrl = __webpack_exports__.dP;
var __webpack_exports__stripCloudinaryUrl = __webpack_exports__.GL;
var __webpack_exports__toggleFullscreen = __webpack_exports__.V9;
var __webpack_exports__withSpecialtyTag = __webpack_exports__.lW;
var __webpack_exports__withoutSpecialtyTag = __webpack_exports__.VQ;
export { __webpack_exports__asJpg as asJpg, __webpack_exports__asMp4 as asMp4, __webpack_exports__base64GifToSrc as base64GifToSrc, __webpack_exports__buildSources as buildSources, __webpack_exports__filterAssetsByTags as filterAssetsByTags, __webpack_exports__findAssetByTags as findAssetByTags, __webpack_exports__findImageByTags as findImageByTags, __webpack_exports__findImagesByTags as findImagesByTags, __webpack_exports__findVideoByTags as findVideoByTags, __webpack_exports__findVideosByTags as findVideosByTags, __webpack_exports__getAssetCoverSize as getAssetCoverSize, __webpack_exports__getBgImages as getBgImages, __webpack_exports__getCloudinaryUrl as getCloudinaryUrl, __webpack_exports__getCloudinaryVersion as getCloudinaryVersion, __webpack_exports__getImageDimensions as getImageDimensions, __webpack_exports__getOptimizedVideo as getOptimizedVideo, __webpack_exports__getVideoPlaceholder as getVideoPlaceholder, __webpack_exports__getVideoPoster as getVideoPoster, __webpack_exports__getVideoThumb as getVideoThumb, __webpack_exports__hexToRgb as hexToRgb, __webpack_exports__importAll as importAll, __webpack_exports__isFullscreen as isFullscreen, __webpack_exports__isJpg as isJpg, __webpack_exports__isMp4 as isMp4, __webpack_exports__isSecure as isSecure, __webpack_exports__isVideoFullscreen as isVideoFullscreen, __webpack_exports__placehold as placehold, __webpack_exports__retainFormat as retainFormat, __webpack_exports__rgbToHex as rgbToHex, __webpack_exports__safePause as safePause, __webpack_exports__safePlay as safePlay, __webpack_exports__sslUrl as sslUrl, __webpack_exports__stripCloudinaryUrl as stripCloudinaryUrl, __webpack_exports__toggleFullscreen as toggleFullscreen, __webpack_exports__withSpecialtyTag as withSpecialtyTag, __webpack_exports__withoutSpecialtyTag as withoutSpecialtyTag };
